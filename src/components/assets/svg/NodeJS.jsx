      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g fill="none">
          ...
          <g transform="translate(134.068 70.501)">
            ...
            <g mask="url(#c)">
              {" "}
              <path fill="#54A044" d="M51.893 1.85L3.121 29.933C1.27 30.974 0 32.94 0 35.02v56.286c0 1.387.578 2.658 1.502 3.698L56.285 1.156c-1.387-.231-3.005-.116-4.392.693zM56.632 125.053c.462-.116.925-.347 1.387-.578l48.773-28.085c1.85-1.04 3.005-3.005 3.005-5.085V35.019c0-1.502-.694-3.005-1.734-4.045l-51.43 94.079z"></path>{" "}
              <path
